...
/**
 * JUnit test class for the HiveScrapper class.
 */
public class HiveScrapperTest {

    private SessionFactory factory;
    private Session session;
    private HiveScrapper hiveScrapper;

    /**
     * Setup method executed before each test.
     * It configures Hibernate, opens a session, and initializes the HiveScrapper.
     */
    @Before
    public void setup() {
    ...
    public void testGetExistingComparison() {
        ...
        Comparison existingComparison = hiveScrapper.getExistingComparison(session, "Test Book", "Test Author", "https://example.com");
        ...
        existingComparison = hiveScrapper.getExistingComparison(session, "Non-existing Book", "Non-existing Author", "https://nonexisting.com");
