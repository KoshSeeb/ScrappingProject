...
/**
 * JUnit test class for the KneetScrapper class.
 */
public class KneetScrapperTest {

    private SessionFactory factory;
    private Session session;
    private KneetScrapper kneetScrapper;

    /**
     * Setup method executed before each test.
     * It configures Hibernate, opens a session, and initializes the KneetScrapper.
     */
    @Before
    public void setup() {
        ...
        kneetScrapper = new KneetScrapper();
    }
    /**
    ...
    public void testGetExistingComparison() {
        ...
        Comparison existingComparison = kneetScrapper.getExistingComparison(session, "Test Book", "Test Author", "https://example.com");
        ...
        existingComparison = kneetScrapper.getExistingComparison(session, "Non-existing Book", "Non-existing Author", "https://nonexisting.com");
