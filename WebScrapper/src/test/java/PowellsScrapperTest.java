...
/**
 * JUnit test class for the PowellsScrapper class.
 */
public class PowellsScrapperTest {

    private SessionFactory factory;
    private Session session;
    private PowellsScrapper powellsScrapper;

    /**
     * Setup method executed before each test.
     * It configures Hibernate, opens a session, and initializes the PowellsScrapper.
     */
    @Before
    public void setup() {
        ...
        powellsScrapper = new PowellsScrapper();
    }
    /**
    ...
    public void testGetExistingComparison() {
        ...
        Comparison existingComparison = powellsScrapper.getExistingComparison(session, "Test Book", "Test Author", "https://example.com");
        ...
        existingComparison = powellsScrapper.getExistingComparison(session, "Non-existing Book", "Non-existing Author", "https://nonexisting.com");
